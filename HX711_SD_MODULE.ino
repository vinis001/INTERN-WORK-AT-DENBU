...
//const float compensation_factor = -475.1042;   
...
//  float compensated_value = compensateValue(rawValue, current_temperature);
...
//float compensateValue(long raw_value, float temperature) {
